...
@section('title', 'Proyect about')


@section('content')
 <div class="container">
	<div class="row">
		<div class="col-xl-4 col-lg-5 col-9 mx-auto mb-2 mb-lg-0">
            <img class="img-fluid rounded" src="/img/about.jpeg">
        </div>
		<div  class="col-xl-8 col-lg-7 col-12 ">
			<h1 class="display-4 text-lg-start text-center text-primary">{{__('About')}}</h1>
